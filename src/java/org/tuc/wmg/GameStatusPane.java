/*
 * GameStatusPane - This file is part of Whack-Mole-Game
...
/**
 * The panel consisting of 3 parts: the information of connection source (source panel), the console
 * of the output (information panel), and the game running status (game panel).
 * 
 * @author Chenfeng Zhu
 *
 */
public class GameStatusPane extends JPanel {
    ...
    public GameStatusPane(final ServerUI server) {
        ...
        sourcePane.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Comm Info:"),
        ...
        gamePane.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Game Stat:"),
    ...
    /**
     * Initialization of the game status panel.
     */
    public void initGamepane() {
        ...
        for (int i = 0; i < num; i++) {
            java.net.URL imgURL = GameStatusPane.class.getClassLoader().getResource(
                    "resources/images/circle_red_48px.png");
    ...
    public void refreshGamePane(int mid, MoleStatus status) {
        for (int i = 0; i < listMoleLabels.size(); i++) {
            ...
            if (mote.getMid() == mid) {
                ...
                case HIT:
                    label.setText("+++ " + i + mote + " +++");
                    imgURL = GameStatusPane.class.getClassLoader().getResource(
                            "resources/images/circle_green_48px.png");
                ...
                case MISSING:
                    label.setText("--- " + i + mote + " ---");
                    imgURL = GameStatusPane.class.getClassLoader().getResource(
                            "resources/images/circle_blue_48px.png");
