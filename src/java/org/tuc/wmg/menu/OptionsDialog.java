...
public class OptionsDialog extends JDialog implements ActionListener {
	...
	private JTextField numTF, timeMTF, timeSTF, molesTF;
	...
	public OptionsDialog(final ServerUI server, Frame owner) {
		...
		sourcePane.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Connection Source:"),
						BorderFactory.createEmptyBorder(1, 1, 1, 1)),
				sourcePane.getBorder()));
		sourceTF = new JTextField(server.getSource(), 20);
		...
		playerPane.setBorder(BorderFactory
				.createCompoundBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Player:"),
						BorderFactory.createEmptyBorder(1, 1, 1, 1)), playerPane.getBorder()));
		nameTF = new JTextField("Player", 20);
		...
		levelPane.setBorder(BorderFactory.createCompoundBorder(
				BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Game Level:"),
						BorderFactory.createEmptyBorder(1, 1, 1, 1)),
				levelPane.getBorder()));
		...
		levelLabel = new JLabel(this.getLevelLabelString());
