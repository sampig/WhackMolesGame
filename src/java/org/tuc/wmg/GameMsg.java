 ...
 * This class implements a Java interface to the 'GameMsg'
 * message type.
 */

package org.tuc.wmg;

public class GameMsg extends net.tinyos.message.Message {
    ...
    /** Create a new GameMsg of size 4. */
    public GameMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new GameMsg of the given data_length. */
    public GameMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new GameMsg with the given data_length
     * and base offset.
     */
    public GameMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new GameMsg using the given byte array
     * as backing store.
     */
    public GameMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public GameMsg(byte[] data, int base_offset) {
     ...
     */
    public GameMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new GameMsg embedded in the given message
     * at the given base offset.
     */
    public GameMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public GameMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
