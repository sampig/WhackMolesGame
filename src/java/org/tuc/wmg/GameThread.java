/*
 * GameThread - This file is part of Whack-Mole-Game
...
public class GameThread implements Runnable, MessageListener {
    ...
    /**
     * Broadcast the information for game start.
     */
    ...
    /**
     * Choose one of the moles randomly. And broadcast its ID.
     */
    protected void sendMoleID() {
        try {
     ...
     *            moteID
     */
    protected void sendStatReply(int source) {
        GameMsg msg = new GameMsg();
        try {
    ...
    /**
     * Game over. Print the results on the console. And broadcast the information of game over.
     */
    protected void sendGameOver() {
        GameMsg msg = new GameMsg();
    ...
    /**
     * Waiting for the response from moles for a short time.
     */
